namespace UglyToad.PdfPig.DocumentLayoutAnalysis.ReadingOrderDetector
{
    ...
    public class UnsupervisedReadingOrderDetector : IReadingOrderDetector
    {
        ...
        private Func<IBlock, IBlock, double, bool> getBeforeInMethod;
            ...
            switch (SpatialReasoningRule)
            {
                case SpatialReasoningRules.ColumnWise:
                    if (UseRenderingOrder)
                    {
                        ...
                        return (IBlock a, IBlock b, double t) => GetBeforeInReadingVertical(a, b, t)
                ...
                case SpatialReasoningRules.RowWise:
                    if (UseRenderingOrder)
                    {
                        return (IBlock a, IBlock b, double t) => GetBeforeInReadingHorizontal(a, b, t)
                                                    || GetBeforeInRendering(a, b);
                    }
                    else
                    {
                ...
                default:
                    if (UseRenderingOrder)
                    {
                        return (IBlock a, IBlock b, double t) => GetBeforeInReading(a, b, t)
                                                    || GetBeforeInRendering(a, b);
                    }
                    else
                    {
        ...
        private static bool GetBeforeInRendering(IBlock alpha, IBlock bravo)
        {
        ...
        private static bool GetBeforeInReading(IBlock a, IBlock b, double T)
        {
        ...
        /// <param name="b"></param>
        /// <param name="T">The tolerance parameter T.</param>
        private static bool GetBeforeInReadingVertical(IBlock a, IBlock b, double T)
        {
            IntervalRelations xRelation = IntervalRelationsHelper.GetRelationX(a.BoundingBox, b.BoundingBox, T);
            IntervalRelations yRelation = IntervalRelationsHelper.GetRelationY(a.BoundingBox, b.BoundingBox, T);
        ...
        /// <param name="b"></param>
        /// <param name="T">The tolerance parameter T.</param>
        private static bool GetBeforeInReadingHorizontal(IBlock a, IBlock b, double T)
        {
            IntervalRelations xRelation = IntervalRelationsHelper.GetRelationX(a.BoundingBox, b.BoundingBox, T);
            IntervalRelations yRelation = IntervalRelationsHelper.GetRelationY(a.BoundingBox, b.BoundingBox, T);
